...
(function() {
  var $, CELL_SIZE, FONT, Line, Point, ShakyCanvas, Text, X, Y, doc, parseASCIIArt, textarea,
    slice = [].slice;
  ...
  $('save').addEventListener('click', function() {
    ...
    setTimeout((function() {
      return doc.body.removeChild(a);
    }), 1000);
    try {
      return a.click();
    } catch (error) {
      e = error;
      return alert("couldn't click");
    }
  });

  if (typeof FONTS_ACTIVE !== "undefined" && FONTS_ACTIVE !== null) {
    drawDiagram();
  }

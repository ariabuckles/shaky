...
(function() {
  var CELL_SIZE, FONT, Line, Point, ShakyCanvas, Text, X, Y, findDimensions, isFontLoaded, loadFont, parseASCIIArt, render, shaky,
    slice = [].slice;
  ...
  findDimensions = function(figures) {
    var figure, height, j, len, width;
    width = 0;
    height = 0;
